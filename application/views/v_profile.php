<div class="container my-5">
          ...
          <div class="modal-content">
            <form action="<?= base_url('setting/profile_picture') ?>" method="post">
              <div class="modal-body mx-3 my-2">
                ...
                <p class="text-muted mt-0 mb-0">Choose one that will be your new profile picture.</p>
  ...
  <?php if($user['user_bio'] != NULL) : ?>
    <p class="mx-lg-5 mx-md-4 mx-sm-4 mt-3 px-lg-5"><?= $user['user_bio'] ?></p>
  <?php endif ?>

  <hr class="mt-4 mb-2 mx-lg-5 mx-md-4 mx-sm-4 px-lg-5" align="center">

  <div class="row mx-lg-5 mx-md-4 mx-sm-4 px-lg-5">
    <div class="col-lg-4 col-md-4 col-sm-12 mt-3">
      <label>Email</label>
      <input type="text" readonly value="<?= $user['user_email'] ?>" class="form-control">

      <label class="mt-3">Phone Number</label>
      <input type="text" readonly value="<?= '+62 '.substr($user['user_phone'], 1, -8).'-'.substr($user['user_phone'], 4, -4).'-'.substr($user['user_phone'], 8) ?>" class="form-control">
    </div>

    <div class="col-lg-1 col-md-1"></div>

    <div class="col-lg-7 col-md-7 col-sm-12 mt-sm-4">
...
<style>
  ...
  #profile_picture:checked + .card{ width: 100%; color: #88619A; box-shadow: 2px 1px 10px #88619A }
